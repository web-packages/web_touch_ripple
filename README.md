...
| --ripple-fadein-curve | This is curve about ripples fade-in and spread animation. | cubic-bezier(.2,.3,.4,1)
| --ripple-fadeout-duration | Duration until the ripple effect disappears. | 0.4s
| --ripple-fadeout-curve | This is curve about ripples fade-out animation. | none
